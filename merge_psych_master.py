...
# Load base psych items
with open('psych_base_items.json', 'r', encoding='utf-8') as f:
    items = json.load(f)

print(f"Total base Psych items: {len(items)}")

# Load all distractors_psych_part*.json
distractor_files = sorted(glob.glob('distractors_psych_part*.json'))
all_distractors = {}
...
with open('psych_master_pristine.json', 'w', encoding='utf-8') as f:
    json.dump(items, f, ensure_ascii=False, indent=2)

print("Saved to psych_master_pristine.json")
