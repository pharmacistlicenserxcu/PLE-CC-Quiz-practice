...
# Load base immunologic items
with open('immuno_base_items.json', 'r', encoding='utf-8') as f:
    items = json.load(f)

print(f"Total base immunologic items: {len(items)}")

# Load all 3 distractor parts
distractors_all = {}
for p in range(1, 4):
    with open(f'distractors_immuno_part{p}.json', 'r', encoding='utf-8') as f:
...
with open('immuno_master_pristine.json', 'w', encoding='utf-8') as f:
    json.dump(items, f, ensure_ascii=False, indent=2)

print("Saved to immuno_master_pristine.json")
