...
# Load base gastrointestinal items
with open('gi_base_items.json', 'r', encoding='utf-8') as f:
    items = json.load(f)

print(f"Total base gastrointestinal items: {len(items)}")

# Load all 4 distractor parts
distractors_all = {}
for p in range(1, 5):
    with open(f'distractors_gi_part{p}.json', 'r', encoding='utf-8') as f:
...
with open('gi_master_pristine.json', 'w', encoding='utf-8') as f:
    json.dump(items, f, ensure_ascii=False, indent=2)

print("Saved to gi_master_pristine.json")
