...
# Load master pristine endocrine questions
with open('endo_master_pristine.json', 'r', encoding='utf-8') as f:
    items = json.load(f)

print(f"Loaded {len(items)} pristine endocrine items.")

wb = openpyxl.load_workbook('PLE CC QUIZ.xlsx')
sheet_name = '4. Endocrine'
...
print(f"Successfully wrote {len(items)} rows to 4. Endocrine.")
