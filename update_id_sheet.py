...
# Load master pristine infectious diseases questions
with open('id_master_pristine.json', 'r', encoding='utf-8') as f:
    items = json.load(f)

print(f"Loaded {len(items)} pristine ID items.")

wb = openpyxl.load_workbook('PLE CC QUIZ.xlsx')
sheet_name = '8. Infectious diseases'
