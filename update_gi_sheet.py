...
# Load master pristine gastrointestinal questions
with open('gi_master_pristine.json', 'r', encoding='utf-8') as f:
    items = json.load(f)

print(f"Loaded {len(items)} pristine gastrointestinal items.")
...
print(f"Successfully wrote {len(items)} rows to 5. Gastrointestinal.")
