...
# Load master pristine hematologic questions
with open('hemato_master_pristine.json', 'r', encoding='utf-8') as f:
    items = json.load(f)

print(f"Loaded {len(items)} pristine hematologic items.")

wb = openpyxl.load_workbook('PLE CC QUIZ.xlsx')
sheet_name = '6. Hematologic'
...
print(f"Successfully wrote {len(items)} rows to 6. Hematologic.")
