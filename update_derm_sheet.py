...
# Load master pristine dermatologic questions
with open('derm_master_pristine.json', 'r', encoding='utf-8') as f:
    items = json.load(f)

print(f"Loaded {len(items)} pristine dermatologic items.")

wb = openpyxl.load_workbook('PLE CC QUIZ.xlsx')
sheet_name = '3. Dermatologic'
...
print(f"Successfully wrote {len(items)} rows to 3. Dermatologic.")
